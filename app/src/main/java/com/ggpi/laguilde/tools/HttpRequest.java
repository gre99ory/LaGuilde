 ...
 *com.example.ggpi.jsonsample.HttpRequest req=new com.example.ggpi.jsonsample.HttpRequest("http://host:port/path");
 *
...
public class HttpRequest {
    //Supported com.example.ggpi.jsonsample.HttpRequest methods
    ...
    //@return com.example.ggpi.jsonsample.HttpRequest this instance -> for chaining method @see line 22
    public HttpRequest prepare() throws IOException{
        prepareAll(Method.GET);
        return this;
    }
    /**
     * Prepares com.example.ggpi.jsonsample.HttpRequest method with for given method, possible values: com.example.ggpi.jsonsample.HttpRequest.Method.POST,
     * com.example.ggpi.jsonsample.HttpRequest.Method.PUT, com.example.ggpi.jsonsample.HttpRequest.Method.GET & com.example.ggpi.jsonsample.HttpRequest.Method.DELETE
     *
     * @param method com.example.ggpi.jsonsample.HttpRequest.Method - nested enum com.example.ggpi.jsonsample.HttpRequest.Method constant
     * @return com.example.ggpi.jsonsample.HttpRequest this instance -> for chaining method @see line 22
     * @throws IOException - should be checked by caller
     * */
